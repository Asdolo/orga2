...
smalltiles_asm:
  ...
  shr rcx, 4                              ; rcx = ancho/8

.ciclo:
   movdqu xmm0, [rdi]                     ; xmm0 = | -- | p2 | -- | p0 |
   movdqu xmm1, [rdi+16]                  ; xmm1 = | -- | p6 | -- | p4 |

   pshufb xmm0, xmm8                      ; xmm0 = | 00 | 00 | p2 | p0 |
   pshufb xmm1, xmm9                      ; xmm1 = | p6 | p4 | 00 | 00 |

   paddb xmm0, xmm1                       ; xmm0 = | p6 | p4 | p2 | p0 |



   movdqu [rsi], xmm0                     ; PONGO DESTINO PUNTERO ABAJO IZQUIERDA
   movdqu [r12], xmm0                     ; PONGO DESTINO PUNTERO ABAJO DERECHA
   movdqu [r13], xmm0                     ; PONGO DESTINO PUNTERO ARRIBA IZQUIERDA
   movdqu [r14], xmm0                     ; PONGO DESTINO PUNTERO ARRIBA DERECHA
   add rdi, 16                            ; LE SUMO 16 BYTES PORQUE ME QUIERO MOVER 4 PIXEL
   add rsi, 16                            ; LE SUMO 8 BYTES PORQUE SOLO ESCRIBI 2 PIXEL
   add r12, 16                            ; LE SUMO 8 BYTES PORQUE SOLO ESCRIBI 2 PIXEL
   add r13, 16                            ; LE SUMO 8 BYTES PORQUE SOLO ESCRIBI 2 PIXEL
   add r14, 16                            ; LE SUMO 8 BYTES PORQUE SOLO ESCRIBI 2 PIXEL
