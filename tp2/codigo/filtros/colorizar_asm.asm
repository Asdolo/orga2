 ...
 .ciclo:
    ...
    ;         127       119       111       103       95        87        79        71        63        55        47        39        31        23        15        7       0
      ...
      ;         127     111     95      79      63      47      31      15    0
    	...
    	movdqu xmm1, xmm0
    	; xmm1 = | maxB1 | maxR1 | maxG1 | maxB1 | maxB0 | maxR0 | maxG0 | maxB0 |
      ;         127     111     95      79      63      47      31      15    0

    	pshufb xmm1, [mask2]
    	; xmm1 = | maxG1 | maxG1 | maxR1 | maxR1 | maxG0 | maxG0 | maxR0 | maxR0 |
      ;         127     111     95      79      63      47      31      15    0
    	...
    	; xmm1 = | maxB1 <= maxG1 | maxR1 <= maxG1 | maxG1 <= maxR1 | maxB1 <= maxR1 | maxB0 <= maxG0 | maxR0 <= maxG0 | maxG0 <= maxR0 | maxB0 <= maxR0 |
    	;         127              111              95               79               63               47               31               15             0
      ...
      ; xmm2 = |        0       |        0       |        0       | maxG1 <= maxR1 |        0       |        0       |        0       | maxG0 <= maxR0 |
    	;         127              111              95               79               63               47               31               15             0

      pand xmm2, xmm0

      ; xmm2 = |        0       |        0       |        0       | maxR1 >= maxG1 && maxR1 >= maxB1 |        0       |        0       |        0       | maxR0 >= maxG0 && maxR0 >= maxB0 |
    	;         127              111              95               79                                 63               47               31               15                               0

      ; me guardo la mascara de phiR en xmm6
      movdqu xmm6, xmm2
      ...
      ; xmm2 = | maxG1 > maxR1 |        0       |        0       |        0       | maxG0 > maxR0 |        0       |        0       |        0       |
    	;         127              111              95               79               63               47               31               15             0

      pand xmm2, xmm1

      ; xmm2 = |        0       |        0       |        0       | maxR1 < maxG1 && maxG1 >= maxB1 |        0       |        0       |        0       | maxR0 < maxG0 && maxG0 >= maxB0 |
    	;         127              111              95               79                                63               47               31               15                              0

      ; me guardo la mascara de phiG en xmm7
      movdqu xmm7, xmm2
      ...
      ; xmm2 = |        0       |        0       |        0       | maxB1 > maxG1 |        0       |        0       |        0       | maxB0 > maxG0 |
    	;         127              111              95               79              63               47               31               15            0

      pand xmm2, xmm0

      ; xmm2 = |        0       |        0       |        0       | maxR1 < maxB1 && maxG1 < maxB1 |        0       |        0       |        0       | maxR0 < maxB0 && maxG0 < maxB0 |
    	;         127              111              95               79                               63               47               31               15                             0

      ; me guardo la mascara de phiB en xmm8
      movdqu xmm8, xmm2
