...
for (int f = 0; f < filas; f+=2) {
		...
		//Agarramos punteros a pixeles del bloque
			...
			unsigned char promedioBlue = (p_s1->b+p_s2->b+p_s3->b+p_s4->b)/4;
			unsigned char promedioGreen = (p_s1->g+p_s2->g+p_s3->g+p_s4->g)/4;
			unsigned char promedioRed = (p_s1->r+p_s2->r+p_s3->r+p_s4->r)/4;
			unsigned char promedioA = (p_s1->a+p_s2->a+p_s3->a+p_s4->a)/4;
